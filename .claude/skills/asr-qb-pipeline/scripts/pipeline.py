...
用法：
  uv run python .claude/skills/asr-qb-pipeline/scripts/pipeline.py classify --class X --student Y
  uv run python .claude/skills/asr-qb-pipeline/scripts/pipeline.py match --class X --student Y
  uv run python .claude/skills/asr-qb-pipeline/scripts/pipeline.py all --class X --student Y
"""
